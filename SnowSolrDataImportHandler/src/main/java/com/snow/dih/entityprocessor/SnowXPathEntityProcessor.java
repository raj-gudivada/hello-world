package com.snow.dih.entityprocessor;
...
public class SnowXPathEntityProcessor extends EntityProcessorBase {
		...
		if (xslt != null) {
			...
			try {
				...
				try {
					...
					// some XML parsers are broken and don't close the byte stream (but they should
					// according to spec)
